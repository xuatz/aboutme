...
<div class="min-h-screen p-8 bg-gradient-to-br from-primary-light via-primary-light to-amber-200 dark:from-primary-dark dark:via-primary-dark dark:to-gray-900">
  <div class="max-w-4xl mx-auto">
    ...
    <div class="grid gap-8">
      ...
      <div class="p-6 transition-transform duration-300 transform bg-white shadow-lg dark:bg-gray-800 rounded-xl hover:-translate-y-1">
        ...
        <p class="text-secondary-light/70 dark:text-secondary-dark/70">
          This space will soon be filled with interesting thoughts, tech discoveries, 
          and various other topics that catch my attention.
        </p>
      </div>
    </div>
  </div>
